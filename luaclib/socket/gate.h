...
int gate_send(struct gate_ctx* gate,uint32_t client_id,ushort message_id,void* data,size_t size);
int gate_close(struct gate_ctx* gate,uint32_t client_id,int grace);
