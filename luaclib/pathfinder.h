...
void finder_raycast(struct pathfinder* finder, int x0, int z0, int x1, int z1, int ignore, int* rx, int* rz, finder_dump dump, void* ud);
void finder_raycast_breshenham(struct pathfinder* finder, int x0, int z0, int x1, int z1, int ignore, int* rx, int* rz, finder_dump dump, void* ud);
